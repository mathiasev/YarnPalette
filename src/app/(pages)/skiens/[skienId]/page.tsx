...
import { SkienImage } from "~/app/_components/_skiens/skien_image";
...
export default function SkienPage({ params }: { params: { skienId: string } }) {
    ...
    const updateDescription = api.skien.updateDescription.useMutation({
        onSuccess: () => {
            ...
            utils.skien.getByIdProtected.invalidate({ id: skien.data?.id });
        }
    });
            ...
            <main className="grid flex-1 items-start gap-4  md:gap-8 lg:grid-cols-3 xl:grid-cols-3">
                ...
                <div>
                    <Card className="overflow-hidden">
                        <SkienImage skienId={skien.data?.id} />
                            ...
                            {skien.data?.color &&
                                <>
                                    <div className="grid gap-3">
                                        ...
                                        <div className="w-full h-12" style={{ backgroundColor: skien.data?.color }}>
                                        </div>
                                    </div>
